...
ActiveRecord::Schema.define(version: 2022_05_18_212732) do
  ...
  create_table "forwardable_forwarded_tos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["forwardable_type", "forwardable_id"], name: "index_forwardable_forwarded_tos_on_forwardable"
  ...
  create_table "group_transactions", force: :cascade do |t|
    ...
    t.index ["transactionable_type", "transactionable_id"], name: "index_group_transactions_on_transactionable"
  end
  ...
  create_table "requestable_requesters", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["requestable_type", "requestable_id"], name: "index_requestable_requesters_on_requestable"
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "group_id"
    t.decimal "total_quantity_procured"
  ...
  create_table "transaction_froms", force: :cascade do |t|
    ...
    t.index ["transactionable_type", "transactionable_id"], name: "index_transaction_froms_on_transactionable"
  end
  ...
  create_table "transaction_tos", force: :cascade do |t|
    ...
    t.index ["transactionable_type", "transactionable_id"], name: "index_transaction_tos_on_transactionable"
  end
  ...
  create_table "videos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clipable_type", "clipable_id"], name: "index_videos_on_clipable_type_and_clipable_id"
  end
